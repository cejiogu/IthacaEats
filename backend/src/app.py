import json
from db import Restaurant, User, Review
...
def delete_restaurant(rest_id):
    ...
    db.session.commit()
    return success_response(f"Restaurant {rest_id} has been deleted!", 201)
...
@app.route("/user/<int:user_id>/restaurants/<int:rest_id>/", methods=["POST"])
